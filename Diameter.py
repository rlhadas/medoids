...
def calculate_equal_enter_score(zero_loss, enter_table, u, uA, uA_loss_events, uB, uB_loss_events,
    ...
    for a_event in uA_loss_events:
        ...
        for b_event in uB_loss_events:
            b_child = b_event[1][1]
            scores += [enter_table[u][(u, a_child)][(u, b_child)]] # RR - Here it looks like they combine the cases of both the losses being the same, and being different. If the code works, clearly that's okay, but I'm not super clear why?
